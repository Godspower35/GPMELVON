...
class TemplateSettings(models.Model):
    ...
    def _default_so_template(self):
        def_tpl = self.env["ir.ui.view"].search(
            [
                ("key", "like", "professional_templates.SO_%_document"),
                ("type", "=", "qweb"),
            ],
            order="key asc",
            limit=1,
    ...
    def _default_po_template(self):
        def_tpl = self.env["ir.ui.view"].search(
            [
                ("key", "like", "professional_templates.PO_%_document"),
                ("type", "=", "qweb"),
            ],
            order="key asc",
            limit=1,
    ...
    def _default_rfq_template(self):
        def_tpl = self.env["ir.ui.view"].search(
            [
                ("key", "like", "professional_templates.RFQ_%_document"),
                ("type", "=", "qweb"),
            ],
            order="key asc",
            limit=1,
    ...
    def _default_dn_template(self):
        def_tpl = self.env["ir.ui.view"].search(
            [
                ("key", "like", "professional_templates.DN_%_document"),
                ("type", "=", "qweb"),
            ],
            order="key asc",
            limit=1,
    ...
    def _default_pk_template(self):
        def_tpl = self.env["ir.ui.view"].search(
            [
                ("key", "like", "professional_templates.PICK_%_document"),
                ("type", "=", "qweb"),
            ],
            order="key asc",
            limit=1,
    ...
    def _default_payment_template(self):
        def_tpl = self.env["ir.ui.view"].search(
            [
                ("key", "like", "professional_templates.PAYMENT_%_document"),
                ("type", "=", "qweb"),
            ],
            order="key asc",
            limit=1,
    ...
    def _default_inv_template(self):
        def_tpl = self.env["ir.ui.view"].search(
            [
                ("key", "like", "professional_templates.INVOICE_%_document"),
                ("type", "=", "qweb"),
            ],
            order="key asc",
            limit=1,
    ...
    template_inv = fields.Many2one(
        ...
        domain="[('type', '=', 'qweb'), ('key', 'like','professional_templates.INVOICE_%_document' )]",
        required=False,
    )
    template_so = fields.Many2one(
        ...
        domain="[('type', '=', 'qweb'), ('key', 'like','professional_templates.SO_%_document' )]",
        required=False,
    )
    ...
    template_po = fields.Many2one(
        ...
        domain="[('type', '=', 'qweb'), ('key', 'like','professional_templates.PO_%_document' )]",
        required=False,
    )
    ...
    template_rfq = fields.Many2one(
        ...
        domain="[('type', '=', 'qweb'), ('key', 'like','professional_templates.RFQ_%_document' )]",
        required=False,
    )
    ...
    template_dn = fields.Many2one(
        ...
        domain="[('type', '=', 'qweb'), ('key', 'like','professional_templates.DN_%_document' )]",
        required=False,
    )
    ...
    template_pk = fields.Many2one(
        ...
        domain="[('type', '=', 'qweb'), ('key', 'like','professional_templates.PICK_%_document' )]",
        required=False,
    )
    ...
    template_payment = fields.Many2one(
        ...
        domain="[('type', '=', 'qweb'),('key','like','professional_templates.PAYMENT_%_document' )]",
        required=False,
    )
